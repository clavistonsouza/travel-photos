#!/bin/bash
# Import Toronto photos into the website
SRC="$HOME/Downloads/Toronto"
...
START_NUM=$(( ${START_NUM:-600} + 1 ))

echo "🍁  Importing Toronto photos..."
...
echo ""
echo "📋 Toronto: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
