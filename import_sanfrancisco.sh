#!/bin/bash
# Import San Francisco photos into the website
SRC="$HOME/Downloads/san"
DEST="$HOME/Documents/Claude/Projects/website-instagram/photos"
START_NUM=601

echo "🌉  Importing San Francisco photos..."
...
echo ""
echo "📋 Paste this back to Claude so it can update the website:"
echo "   San Francisco: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
