#!/bin/bash
# Import Sequoia National Park photos into the website
SRC="$HOME/Downloads/sequoia"
...
START_NUM=$(( ${START_NUM:-613} + 1 ))

echo "🌲  Importing Sequoia National Park photos..."
...
echo ""
echo "📋 Sequoia NP: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
