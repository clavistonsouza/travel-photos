#!/bin/bash
# Import Cunhanight photos into the website, skipping videos
SRC="$HOME/Downloads/cunha-export"
DEST="$HOME/Documents/Claude/Projects/website-instagram/photos"
START_NUM=530

echo "🌙 Importing Cunha night photos..."
...
while IFS= read -r -d '' f; do
  ...
  if [[ "$ext_lower" == "jpg" || "$ext_lower" == "jpeg" || "$ext_lower" == "heic" ]]; then
    FILES+=("$f")
  fi
