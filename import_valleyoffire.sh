#!/bin/bash
# Import Valley of Fire photos into the website
SRC="$HOME/Downloads/valley"
...
echo "🔥  Importing Valley of Fire photos..."
...
echo ""
echo "📋 Valley of Fire: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
