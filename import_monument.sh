#!/bin/bash
# Import Monument Valley photos into the website
SRC="$HOME/Downloads/monument"
...
echo "🏜️  Importing Monument Valley photos..."
...
echo ""
echo "📋 Monument Valley: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
