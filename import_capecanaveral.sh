#!/bin/bash
# Import Cape Canaveral photos into the website
SRC="$HOME/Downloads/Cape"
...
echo "🚀  Importing Cape Canaveral photos..."
...
echo ""
echo "📋 Cape Canaveral: $COUNT photos, photo_$(printf '%03d' $START_NUM) → photo_$(printf '%03d' $((NUM-1)))"
